...
--------------------------------------------------------------------------------
----------Basado en tutorial:---------------------------------------------------
----------Modificado de https://github.com/techwithtim/PygameForBeginners-------
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
"""
...
def main():
	...
	while game_active:
		...
		low_red = np.array([165 , 100, 150])	# límite inferior para capturar el color rojo en el espacio HSV
